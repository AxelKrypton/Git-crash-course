...
\AtBeginSection % <- Non-empty optional argument, do it also for \section*
{
...
\begin{frame}{Git is your friend!}
    ...
    \end{varblock}
    \FrameRemark{Even in some cases when changes seem lost, \,\texttt{git reflog}\; or \;\texttt{git fsck}\; could rescue you. \URL*{https://stackoverflow.com/a/7147749/14967071}{Here} a nice overview.}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
\begin{frame}<0>[plain, noframenumbering, label=Wow]{}
    % Apparently the includemedia command affects the slide page
    % and therefore we place other content first.
    \PrepareURLsymbol[PB]
    \begin{tikzpicture}[remember picture, overlay]
        \node[font=\small, visible on=<1>] at ($(current page.center)!0.75!(current page.south)$) {
            The Git prompt I use in my \textbf{Bash} terminal is a customization of \URL*{https://github.com/magicmonty/bash-git-prompt}{this one}!
        };
    \end{tikzpicture}
    \vfill
    \begin{center}
...
\begin{frame}[fragile]{Cloning a remote repository}
    ...
    \PrepareURLsymbol[PB]
    \FrameRemark{
        Usually, you can clone a repository using either a HTTPS or an SSH URL.
        See e.g.\ \URL*{https://docs.github.com/en/get-started/git-basics/about-remote-repositories}{GitHub documentation} for more insights about these alternatives.
    }
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
