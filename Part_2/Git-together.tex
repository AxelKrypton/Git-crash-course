...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}[plain, noframenumbering, label=Wow]{}
    \centering
    \vfill
...
\begin{frame}{What if I want neither to commit nor to restore?}
    \begin{varblock}{}[\textwidth]{From Git documentation}
        Often, when you’ve been working on part of your project, things are in a messy state and you want to switch branches for a bit to work on something else. The problem is, you don’t want to do a commit of half-done work just so you can get back to this point later. The answer to this issue is \textbf{\PP{the git}} stash command.
    \end{varblock}
    ...
    \end{itemize}
    \FrameRemark{$^\star$Although if people still refer to the stashing area as a stack, the last-in-first-out principle is not anymore a must and item in the middle of the stack can be used.}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
\begin{frame}[fragile]{A taste about stashing}
    ...
    \FrameRemark{
        \begin{tabular}{c}
            Using \,\texttt{apply}\, instead of \,\texttt{pop}\, the entry in the stash list untouched.\\
...
%===============================================================%
\section{Conclusions and live exercise}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\againframe[plain]{Wow}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}{That's \textbf{ALMOST} all folks}
    ...
    \begin{enumerate}[<+->]
        ...
        \item You can use Git to work in a very professional way!\\
              $\to\;$ Come to next Z02 talk: \alert{\guillemotleft Git in real \tikzmark{tg}life\guillemotright}
    \end{enumerate}
    \begin{tikzpicture}[remember picture, overlay, scope on=<.->]
        \node[anchor=west, space=PT, text width=28mm] (content) at ($(tg)+(0.5,-1.5)$) {
            git rebase\\
            git tag\\
            Semantic versioning\\
            Gitflow\\
...
\begin{frame}[fragile]{Let's collaborate!}
    ...
    \begin{enumerate}
        ...
        \item Clone the exercise repository from Redmine\\
              \then \raisebox{1pt}{\scriptsize\texttt{https://<USERNAME>@git.physik.uni-bielefeld.de/<IDENTIFIER>}}
